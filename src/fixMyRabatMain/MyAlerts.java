...
public class MyAlerts extends HttpServlet {


	    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {

	   		UserService userService = UserServiceFactory.getUserService();   	
	    	Query q = new Query("Alerte").addFilter("User",Query.FilterOperator.EQUAL,userService.getCurrentUser().getNickname());
	     ...
	     resp.setContentType("text/html;charset=UTF-8");
   		 ...
   		 out.print("<style>");
   		 out.print("html{overflow:scroll;}");
   		 out.print("</style>");
   		...
   		out.print("<div class=\"container\"><div class=\"row\"><div class=\"col-lg-12\"><h1 class=\"page-header\">Mes Alertes :</h1></div></div>");
